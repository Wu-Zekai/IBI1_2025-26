...
Maxium_increase_country = sorted_countries[0]
Maxium_decrease_country = sorted_countries[-1]
Maxium_increase_change = sorted_changes[0]
Maxium_decrease_change = sorted_changes[-1]
...
plt.bar(sorted_countries, sorted_changes)
